...
# from sota.MDCUN.model.deepfuse import MEF_SSIM_Loss

# from sota.MDCUN.utils.vgg import VGG
...
def save_config(dir, log):
    open_type = 'a' if os.path.exists(get_path(dir + '/records.txt')) else 'w'
    log_file = open(get_path(dir + '/records.txt'), open_type)
    log_file.write(str(log) + '\n')

def save_net_config(dir, log):
    open_type = 'a' if os.path.exists(get_path(dir+'/net.txt')) else 'w'
    log_file = open(get_path(dir+'/net.txt'), open_type)
    log_file.write(str(log) + '\n')
