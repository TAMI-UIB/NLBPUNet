...
class ResourceManager(object):
    def __init__(self, block_size=128, block_num = 1600, network='mddl', test_img='record_6.mat', dataset='gf2', resource=r'resource/{}',
        ...
        if not warm_start:
            ...
            # there are not qb-real
                record = loadmat(join(self.resource.format('wv2_real'),'full')) # self.dataset+'_real'
            else: 
                record = loadmat(join(self.resource.format('gf2_real'),'full')) # self.dataset+'_real'
    ...
    #Read data from the given file paths and return a list of test data and training data
